...
namespace 這是扭蛋機系統
{
    public partial class Form1 : Form
    {
        ...
        public Form1(int userId)
        {
            ...
            this.IsMdiContainer = true; // ✅ 設定 MDI 容器3
        ...
        private async Task LoadMemberDataAsync()
        {
            ...
            var member = await _registerService.GetMemberByIdAsync(_userId); // ✅ 調用 API 獲取會員資料
        ...
        private void btnGashaponLog_Click(object sender, EventArgs e)
        {
            if (GashaponLog == null)
            {
                GashaponLog = new FormGashaponLog();
        ...
        private void btnBuyMoney_Click(object sender, EventArgs e)
        {
            if (BuyMoney == null)
            {
                BuyMoney = new FormBuyMoney();
                BuyMoney.FormClosed += BuyMoney_FormClosed;
                BuyMoney.MdiParent = this;
                BuyMoney.Dock = DockStyle.Fill;
                BuyMoney.Show();
            }
            else
            {
        ...
        private void BuyMoney_FormClosed(object sender, FormClosedEventArgs e)
        {
            BuyMoney.Activate();
        }
